...
interface ConsumeBillDao {
    ...
    /** 更新一条消费账单 */
    @Update
    suspend fun update(bill: ConsumeBill)

    /** 删除一条消费账单 */
    @Delete
    suspend fun delete(bill: ConsumeBill)
